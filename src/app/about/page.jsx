        ...
        <div className='p-4 sm:p-8 md:p-12 lg:p-20 xl:p-32 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:pr-0 lg:w-2/3 xl:1/2'>
          ...
          ref={bioRef} className='flex flex-col gap-12 justify-center'>
            ...
            <p className="text-lg dark:text-white tracking-wide">
              Me gusta mucho la programacion. No hay nada que me guste mas que aprender nuevas tecnologias y probarlas, es mi hobbie favorito, luego claramente está jugar Super Smash Bros Ultimate
            </p>
            {/* BIOGRAPHY QUOTE */}
            ...
            <div className="self-end">
              ...
              <svg className='invert dark:invert-0 rounded-lg' width="224" height="56" viewBox="0 0 224 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2 2.65816C7.13677 2.65816 12.5148 3.07764 17.7826 2.98724C23.2925 2.89267 28.6992 2 34.2609 2C42.087 2 49.913 2 57.7391 2C63.1513 2 68.6127 2.65816 74 2.65816" stroke="white" strokeWidth="3" strokeLinecap="round" />
                <path d="M42.5251 2C42.5251 9.84691 45.2115 17.9867 43.3332 25.6787C42.8953 27.4721 41.4894 28.9468 40.3848 30.3518C38.4497 32.8134 36.6452 35.3736 34.7502 37.8646C33.1184 40.0097 30.9476 41.0926 29.0282 42.8508C28.4166 43.411 28.0938 44.5595 27.1937 44.6619C25.6483 44.8377 24.5229 45.2299 22.8258 44.8184C20.7468 44.3143 18.8949 42.7995 16.9291 41.9341C15.4651 41.2896 13.9208 40.5928 12.6485 39.5863C7.48514 35.5015 4 29.9816 4 23.331" stroke="white" strokeWidth="3" strokeLinecap="round" />
          ...
          <motion.div initial={{ x: "-300px" }} animate={isSkillRefInView ? { x: 0 } : {}}
            ...
            <h2 
              className='font-bold text-2xl dark:text-white'>SKILSS</h2>
            <TecIcons />
