    ...
    >
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center gap-8 pb-16 md:py-8">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-6">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-center lg:text-left text-black dark:text-white">
            Full Stack Developer
          </h1>
          <p className="text-lg text-center lg:text-left text-black dark:text-white leading-relaxed">
          ...
          <div className="flex gap-4 justify-center lg:justify-start">
            <Link className="hidden sm:flex" href="/portfolio">
              <button className="px-6 py-3 rounded-lg ring-1 dark:ring-white ring-black text-black dark:text-white dark:hover:bg-slate-700 hover:bg-blue-300 transition duration-300 ease-in-out">
                View my work
              </button>
            </Link>
